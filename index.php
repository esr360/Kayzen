    ...
    <div id="site-content">
                ...
                <div class="app-header_wrapper">
                    ...
                    <nav class="navigation-style-1" id="app-nav">
                        <ul>
                            ...
                            <li><a href="#"><i class="fa fa-star"></i> Features</a></li>
                            <li><a href="#"><i class="fa fa-list-ul"></i> Shortcodes</a></li>
                        </ul>
                    </nav>
        ...
        <main id="main">
            ...
            <section class="section-secondary promo-banner">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="span-4 va-middle text-right button_group">
                            <a href="#" target="blank" class="button-white-border-size-3">Purchase Theme</a>
			...
			<section class="section-secondary promo-banner text-center">
            	<a href="#" target="blank" class="button-white-border-size-4">Get Kayzen Now</a>
            </section>
			...
			<section class="section-primary">
				...
				<!-- Contact Form -->
				<form class="form-faux-placeholders-html5 container-small">
		            <div class="row-flow">
