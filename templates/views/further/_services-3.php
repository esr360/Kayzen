    ...
    <div class="container-small">
        <div class="row">
            <div class="span-5 va-middle text-center min-break-3">
                <img class="span-10<?php if ($GLOBALS['theme'] !== 'Kayzen') echo ' greyscale' ?>" src="<?php echo appDir ?>/images/layouts/layout-header-alt.png" alt="" />
            </div>
...
<section class="section-primary" id="unique-configuration">
    <div class="container-small">
        <div class="row">
            ...
            <div class="span-5 va-middle text-center min-break-3">
                <img class="span-10<?php if ($GLOBALS['theme'] !== 'Kayzen') echo ' greyscale' ?>" src="<?php echo appDir ?>/images/layouts/layout-topbar.png" alt="" />
            </div>
        </div>
    </div>
</section>
