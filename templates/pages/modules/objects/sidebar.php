<?php 
	...
	// page config
	$title = 'Sidebar';
	$tagLine = 'app/modules/objects/sidebar';
?>
    ...
    <div id="site-content">
		...
		<section class="section-primary">
			...
			<div class="container-small">
				...
				<p class="alert-bar-info"><strong>Github Page</strong> (customers only):  <a href="https://github.com/esr360/Kayzen/tree/master/app/modules/objects/sidebar" target="blank">https://github.com/esr360/Kayzen/tree/master/app/modules/objects/sidebar</a></p>
...
&lt;/aside>
				...
				<p>To change one of the above values, pass your new value(s) to the <code>sidebar()</code> mixin in your theme file (e.g. app/themes/Kayzen/_kayzen.scss).</p>
