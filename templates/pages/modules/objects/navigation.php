<?php 
	...
	// page config
	$title = 'Navigation';
	$tagLine = 'app/modules/objects/navigation';
?>
    ...
    <div id="site-content">
		...
		<section class="section-primary">
			...
			<div class="container-small">
				...
				<p class="alert-bar-info"><strong>Github Page</strong> (customers only):  <a href="https://github.com/esr360/Kayzen/tree/master/app/modules/objects/navigation" target="blank">https://github.com/esr360/Kayzen/tree/master/app/modules/objects/navigation</a></p>
