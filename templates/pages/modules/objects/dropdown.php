<?php 
	...
	// page config
	$title = 'Dropdown';
	$tagLine = 'app/modules/objects/dropdown';
?>
    ...
    <div id="site-content">
		...
		<section class="section-primary">
			...
			<div class="container-small">
				...
				<p class="alert-bar-info"><strong>Github Page</strong> (customers only):  <a href="https://github.com/esr360/Kayzen/tree/master/app/modules/objects/dropdown" target="blank">https://github.com/esr360/Kayzen/tree/master/app/modules/objects/dropdown</a></p>
...
&lt;/div>
				...
				<p>To change one of the above values, pass your new value(s) to the <code>dropdown()</code> mixin in your theme file (e.g. app/themes/Kayzen/_kayzen.scss).</p>
