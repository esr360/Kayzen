<?php 
	...
	// page config
	$title = 'Mega Menu';
	$tagLine = 'app/modules/objects/mega-menu';
?>
    ...
    <div id="site-content">
		...
		<section class="section-primary">
			...
			<div class="container-small">
				...
				<p class="alert-bar-info"><strong>Github Page</strong> (customers only):  <a href="https://github.com/esr360/Kayzen/tree/master/app/modules/objects/mega-menu" target="blank">https://github.com/esr360/Kayzen/tree/master/app/modules/objects/mega-menu</a></p>
...
&lt;/nav>
				...
				<p>To change one of the above values, pass your new value(s) to the <code>mega-menu()</code> mixin in your theme file (e.g. app/themes/Kayzen/_kayzen.scss).</p>
