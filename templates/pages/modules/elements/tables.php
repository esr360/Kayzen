<?php 
	...
	// page config
	$title = 'Tables';
	$tagLine = 'assets/modules/elements/tables';
?>
    ...
    <div id="site-content">
		...
		<section class="section-primary">
			...
			<div class="container-small">
				...
				<p class="alert-bar-info"><strong>Github Page</strong> (customers only):  <a href="https://github.com/esr360/Kayzen/tree/master/assets/modules/elements/tables" target="blank">https://github.com/esr360/Kayzen/tree/master/assets/modules/elements/tables</a></p>
...
&lt;/table>
				...
				<p>To change one of the above values, pass your new value(s) to the <code>tables()</code> mixin in your theme file (e.g. assets/themes/Kayzen/_kayzen.scss).</p>   
