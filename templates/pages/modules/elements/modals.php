<?php 
	...
	// page config
	$title = 'Modals/Popups';
	$tagLine = 'assets/modules/elements/modals';
?>
    ...
    <div id="site-content">
		...
		<section class="section-primary">
			...
			<div class="container-small">
				...
				<p class="alert-bar-info"><strong>Github Page</strong> (customers only):  <a href="https://github.com/esr360/Kayzen/tree/master/assets/modules/elements/modals" target="blank">https://github.com/esr360/Kayzen/tree/master/assets/modules/elements/modals</a></p>
...
&lt;a href="#modal-demo-10" data-modal data-modal-content="Lorem ipsum dolor sit amet." data-modal-style="zoom">Click Me&lt;/a>
				...
				<p>To change one of the above values, pass your new value(s) to the <code>modals()</code> mixin in your theme file (e.g. assets/themes/Kayzen/_kayzen.scss).</p>   
