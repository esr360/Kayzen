    ...
    <div id="site-content">
		...
		<section class="section-primary">
			...
			<div class="container-small">
				...
				<p class="alert-bar-info"><strong>Github Page</strong> (customers only):  <a href="https://github.com/esr360/Kayzen/tree/master/app/modules/elements/forms" target="blank">https://github.com/esr360/Kayzen/tree/master/app/modules/elements/forms</a></p>
...
<&lt;form>
				...
				<p>To change one of the above values, pass your new value(s) to the <code>forms()</code> mixin in your theme file (e.g. app/themes/Kayzen/_kayzen.scss).</p>
