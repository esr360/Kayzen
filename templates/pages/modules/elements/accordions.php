    ...
    <div id="site-content">
		...
		<section class="section-primary">
			...
			<div class="container-small">
				...
				<p class="alert-bar-info"><strong>Github Page</strong> (customers only):  <a href="https://github.com/esr360/Kayzen/tree/master/assets/modules/elements/accordions" target="blank">https://github.com/esr360/Kayzen/tree/master/assets/modules/elements/accordions</a></p>
...
&lt;/div>
				...
				<p>To change one of the above values, pass your new value(s) to the <code>accordions()</code> mixin in your theme file (e.g. assets/themes/Kayzen/_kayzen.scss).</p>
