<?php 
	...
	// page config
	$title = 'Lists & Tags';
	$tagLine = 'assets/modules/elements/lists';
?>
    ...
    <div id="site-content">
		...
		<section class="section-primary">
			...
			<div class="container-small">
				...
				<p class="alert-bar-info"><strong>Github Page</strong> (customers only):  <a href="https://github.com/esr360/Kayzen/tree/master/assets/modules/elements/lists" target="blank">https://github.com/esr360/Kayzen/tree/master/assets/modules/elements/lists</a></p>
...
&lt;/ul>
				...
				<p>To change one of the above values, pass your new value(s) to the <code>lists()</code> mixin in your theme file (e.g. assets/themes/Kayzen/_kayzen.scss).</p>   
